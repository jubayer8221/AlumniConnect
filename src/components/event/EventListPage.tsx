...
export default function EventListPage({
  ...
  const { items, loading, totalCount, search, pageNumber } = useAppSelector(
    (s) => s.events,
  );
    ...
    <Box>
      ...
      <Box sx={{ display: "flex", gap: 2, mb: 2, flexWrap: "wrap" }}>
        <Box sx={{ flexGrow: 1, minWidth: 250 }}>
          <CommonSearchField
            value={search}
            onChange={(v) => dispatch(fetchEventsAsync({ search: v } as never))}
      ...
      {loading ? (
        ...
        <CommonEmptyState
          ...
          icon={<CalendarDays size={48} className="text-gray-300" />}
        />
      ) : (
              ...
              >
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  >
                    ...
                    >
                      <Clock size={14} /> {formatTime(evt.startTime)} -{" "}
                    ...
                    >
                      <MapPin size={14} /> {evt.venue}, {evt.location}
                    </Typography>
                    <Typography
                      variant="caption"
                      sx={{
                    ...
                    >
                      <Users size={14} /> Capacity: {evt.capacity}
                    </Typography>
                  </Box>
                  <Button
                    variant="outlined"
                    fullWidth
                    onClick={() => navigate(`${basePath}/${evt.id}`)}
