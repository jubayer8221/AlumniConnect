...
export const fetchNoticesAsync = createAsyncThunk(
  "notices/fetchAll",
  async (_, { getState }) => {
...
export const createNoticeAsync = createAsyncThunk(
  "notices/create",
  async (data: CreateNoticeRequest, { rejectWithValue }) => {
...
export const publishNoticeAsync = createAsyncThunk(
  "notices/publish",
  async (id: string, { rejectWithValue }) => {
...
export const unpublishNoticeAsync = createAsyncThunk(
  "notices/unpublish",
  async (id: string, { rejectWithValue }) => {
...
const noticeSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchNoticesAsync.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(fetchNoticesAsync.fulfilled, (state, action) => {
        state.loading = false;
        state.items = action.payload.data.items;
        state.totalCount = action.payload.data.totalCount;
      })
      .addCase(fetchNoticesAsync.rejected, (state, action) => {
        state.loading = false;
      ...
      .addCase(fetchNoticeByIdAsync.rejected, (state, action) => {
        state.loading = false;
      ...
      .addCase(createNoticeAsync.fulfilled, (state) => {
        state.loading = false;
      })
      .addCase(createNoticeAsync.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload as string;
      })
      ...
      .addCase(updateNoticeAsync.fulfilled, (state) => {
        state.loading = false;
      })
      .addCase(updateNoticeAsync.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload as string;
      })
      ...
      .addCase(deleteNoticeAsync.fulfilled, (state) => {
        state.loading = false;
      })
      .addCase(deleteNoticeAsync.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload as string;
      })
      .addCase(publishNoticeAsync.fulfilled, (state, action) => {
        state.selectedNotice = action.payload;
        state.items = state.items.map((n) =>
          n.id === action.payload.id ? action.payload : n,
        );
      })
      .addCase(unpublishNoticeAsync.fulfilled, (state, action) => {
        state.selectedNotice = action.payload;
        state.items = state.items.map((n) =>
          n.id === action.payload.id ? action.payload : n,
        );
